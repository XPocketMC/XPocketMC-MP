...
echo "--- This allows you to perform integration tests using xpocketmc-MP, without immediately publishing new versions of these libraries."
...
composer require xpocketmc/bedrock-protocol:*@dev xpocketmc/bedrock-data:*@dev xpocketmc/bedrock-block-upgrade-schema:*@dev xpocketmc/bedrock-item-upgrade-schema:*@dev
