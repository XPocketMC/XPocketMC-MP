...
This is the first beta in the 1.4 series. This is a complete rewrite of xpocketmc-MP, so only plugins developed for this new API will work.
...
- Infinite worlds
- Multithreading!
- New efficient threaded networking library, [RakLib](https://github.com/xpocketmc/RakLib)
...
- Advanced settings on xpocketmc.yml file!
...
- Added settings.query-plugins to xpocketmc.yml
...
- Added worlds directive to xpocketmc.yml to load extra worlds or use a plugin-provided generator
...
- Removed PHP_VERSION constant on xpocketmc namespace
...
- Reactivated chunk ticking _(can be disabled via xpocketmc.yml)_
- Beds! Furnaces!
...
- Moved spl to [xpocketmc-SPL](https://github.com/xpocketmc/xpocketmc-MP)
...
**Main features:**
- Added non-threaded chunk generation, toggleable on xpocketmc.yml
- Added Liquid flow
- Fixed Double Chests
...
This is the first stable build of xpocketmc-MP 1.4. Lots of changes have happened since 1.3.12, and they won't be detailed here. You can find them on the release list here on GitHub.
