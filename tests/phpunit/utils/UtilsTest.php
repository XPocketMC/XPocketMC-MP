...
use xpocketmc\utils\fixtures\TestAbstractClass;
use xpocketmc\utils\fixtures\TestInstantiableClass;
use xpocketmc\utils\fixtures\TestInterface;
use xpocketmc\utils\fixtures\TestSubclassOfInstantiableClass;
use xpocketmc\utils\fixtures\TestTrait;
use function define;
...
class UtilsTest extends TestCase{
	...
	public function setUp() : void{
		if(!defined('xpocketmc\PATH')){
			define('xpocketmc\PATH', 'dummy');
		}
	}
