...
namespace xpocketmc\generate_permission_doc;
...
fwrite($doc, "Permissions may imply permissions which in turn imply other permissions (e.g. {$code}xpocketmc.group.operator{$code} implies {$code}xpocketmc.group.user{$code}, which in turn implies {$code}xpocketmc.command.help{$code}).$newline");
