...
namespace xpocketmc\tools\compact_regions;

use xpocketmc\world\format\io\exception\CorruptedChunkException;
use xpocketmc\world\format\io\region\CorruptedRegionException;
use xpocketmc\world\format\io\region\RegionLoader;
...
if(!defined('xpocketmc\_PHPSTAN_ANALYSIS')){
	exit(main($argv));
}