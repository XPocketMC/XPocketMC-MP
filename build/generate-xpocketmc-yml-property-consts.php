...
$defaultConfig = yaml_parse(Filesystem::fileGetContents(dirname(__DIR__) . '/resources/xpocketmc.yml'));

if(!is_array($defaultConfig)){
	fwrite(STDERR, "Invalid default xpocketmc.yml\n");
	exit(1);
}
...
fwrite($file, "namespace xpocketmc;\n\n");

fwrite($file, <<<'DOC'
/**
 * @internal
 * Constants for all properties available in xpocketmc.yml.
 * This is generated by build/generate-xpocketmc-yml-property-consts.php.
